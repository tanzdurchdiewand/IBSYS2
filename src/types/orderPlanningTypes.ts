...
export const orderDetail: OrderDetailsMap = {
  "21": {
    deliveryTime: 1.8,
    deviation: 0.4,
    requiredQuantityP1: 1,
    requiredQuantityP2: 0,
    requiredQuantityP3: 0,
    discountQuantity: 300,
  },
  "22": {
    deliveryTime: 1.7,
    deviation: 0.4,
    requiredQuantityP1: 0,
    requiredQuantityP2: 1,
    requiredQuantityP3: 0,
    discountQuantity: 300,
  },
  "23": {
    ...
    requiredQuantityP1: 0,
    requiredQuantityP2: 0,
    requiredQuantityP3: 1,
    discountQuantity: 300,
  },
  "24": {
    deliveryTime: 3.2,
    deviation: 0.3,
    requiredQuantityP1: 7,
    requiredQuantityP2: 7,
    requiredQuantityP3: 7,
    discountQuantity: 6100,
  },
  "25": {
    deliveryTime: 0.9,
    deviation: 0.2,
    requiredQuantityP1: 4,
    requiredQuantityP2: 4,
    requiredQuantityP3: 4,
    discountQuantity: 3600,
  },
  "27": {
    deliveryTime: 0.9,
    deviation: 0.2,
    requiredQuantityP1: 2,
    requiredQuantityP2: 2,
    requiredQuantityP3: 2,
  ...
  "28": {
    ...
    deviation: 0.4,
    requiredQuantityP1: 4,
    requiredQuantityP2: 5,
    requiredQuantityP3: 6,
    discountQuantity: 4500,
  },
  "32": {
    deliveryTime: 2.1,
    deviation: 0.5,
    requiredQuantityP1: 3,
    requiredQuantityP2: 3,
    requiredQuantityP3: 3,
