...
import { PlanningType, useMaterialPlanning } from "../hooks/useMaterialPlanning";
    ...
    <Container maxWidth={"xl"} sx={{ p: 3, position: "relative" }}>
      ...
      <StyledCard>
        <TableContainer component={Paper} sx={{width: "90%"}}>
          <Table sx={{ minWidth: 650 }} aria-label="material planning table" stickyHeader size="small">
            <TableHead>
              <TableRow>
            ...
            <TableBody>
              {p1Planning &&
                Object.entries(p1Planning).map(([key, value]) => (
                  <TableRow key={key}>
